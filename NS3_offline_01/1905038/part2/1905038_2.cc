...
store_in_file(std::string file)
{
    ...
    mfile << number_node * 2 << " " << number_flow << " " << num_packets_per_second << " "
          << speed << " "<< throughput_in_average << " " << packet_delivery_ratio << "\n";
...
main(int argc, char* argv[])
{
    ...
    std::string file = "./scratch/1905038/part2/plot/data.txt";
    ...
    cmd.AddValue("speed","Mobile Station Nodes's speed", speed);
    ...
    // Construction of wireless high rate mobile network
